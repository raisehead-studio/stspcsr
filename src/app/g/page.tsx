...
export default function G() {
      ...
      <div className="page_layout">
        <div className="page_content">
          <div className="page_header">
            <strong>
              G: A Sustainable Environment for Industry, Living, Life, and
              Ecology
            </strong>
            <Breadcrumb />
          </div>
          <div>
            <div className="photo_container">
              <Image
                src={"/images/g/en/photo1.png"}
                fill={true}
                alt="profile photo"
              />
              <Image
                src={"/images/g/en/photo2.png"}
                fill={true}
                alt="profile photo"
              />
            </div>
  ...
  return (
    <div className="page_layout">
      <div className="page_content">
        <div className="page_header">
          <strong>G 精實優質服務，確保永續營運</strong>
          <Breadcrumb />
        </div>
        <div>
          <div className="photo_container">
            <Image
              src={"/images/g/zh/photo1.png"}
              fill={true}
              alt="profile photo"
            />
            <Image
              src={"/images/g/zh/photo2.png"}
              fill={true}
              alt="profile photo"
            />
          </div>
